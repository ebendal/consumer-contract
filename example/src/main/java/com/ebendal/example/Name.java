...
public class Name {
    ...
    public static final String BOOK_PROVIDER = "book-service";

    public static final String AUTHOR_PROVIDER = "author-service";
    ...
    public static final String GET_AUTHOR_BY_ID_INTERACTION = "get-author-by-id";
