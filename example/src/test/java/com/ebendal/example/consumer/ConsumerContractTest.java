...
//    @Pact(provider = "author", consumer = "test-consumer")
//    public RequestResponsePact consumerTest(PactDslWithProvider builder) {
//        return builder
//            .uponReceiving("test")
//            .matchPath("^/api/authors/[0-9a-fA-F]{8}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{4}\\b-[0-9a-fA-F]{12}$", "/api/books/4d956508-473c-4d91-ae4b-abc666666cd5")
//            .method("POST")
//            .matchHeader("header", "")
//            .willRespondWith()
//            .status(200)
